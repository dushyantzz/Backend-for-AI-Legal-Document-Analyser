  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="py-12 relative z-10">
        ...
        >
          {isAuthenticated ? `Welcome back, ${user?.first_name}!` : 'Tired of making legal documents?'}
        </Typography>
        <Typography
          color="white"
        ...
        >
          {isAuthenticated 
            ? 'Manage your legal documents, deadlines, and compliance requirements all in one place.'
        ...
        <div className="md:max-w-3xl mx-auto mt-14 -mb-7 px-3">
          ...
          >
            {isAuthenticated ? (
              <>
                Access your personalized dashboard to manage documents, track deadlines, and get AI-powered legal assistance.
                <br />
                Everything you need for legal document management in one place!
              </>
            ) : (
              <>
